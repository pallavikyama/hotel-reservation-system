...
public class HotelReservationTest01 {
	...
	// REWARD CUSTOMER DATE RANGE ENTRY GIVES CHEAPEST, BEST RATED HOTEL AVAILABLE
	@Test
	public void hotelTestUC10() {
		...
		double totalRate = cheapestHotels.get(0).getRewardCustomerRateOnWeekday()
				* HotelReservation.numOfWeekdayBookings
				+ cheapestHotels.get(0).getRewardCustomerRateOnWeekend() * HotelReservation.numOfWeekendBookings;
